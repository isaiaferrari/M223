...
public class CustomerControllerTests {
    ...
    public void testSaveCustomer_Success() throws Exception {
        ...
        mockMvc.perform(post("/customers/insert")
                        ...
                        .param("age", "70")
                        .param("city", "Bellinzona")
                        .param("ccNumber", "4868719081564153")
        ...
        assert savedCustomer.getCity().equals("Bellinzona");
        assert savedCustomer.getCcNumber().equals("4868719081564153");
        assert savedCustomer.getCcExpiration().equals("11/30");
        assert savedCustomer.getCcCVV().equals(234);
    }
